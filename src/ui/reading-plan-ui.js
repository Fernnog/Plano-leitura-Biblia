...
function _renderDailyReading(plan, effectiveDate) {
    ...
    // Lista de Capítulos (MODIFICADO: Adicionado botão neon)
    let chaptersHTML = '';
        ...
        chaptersHTML = chaptersForToday.map((chapter, index) => {
            ...
            return `
                <div class="daily-chapter-item">
                    <button class="neon-highlight-btn" data-action="highlightVerse" data-chapter="${chapter}" title="Marcar versículo para grifar">🖌️</button>
