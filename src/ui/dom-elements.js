...
// --- Modal de Marcação de Versículos (Highlights) ---
export const highlightModal = document.getElementById('highlight-modal');
export const highlightChapterName = document.getElementById('highlight-chapter-name');
export const highlightErrorDiv = document.getElementById('highlight-error');
export const highlightForm = document.getElementById('highlight-form');
export const highlightPlanIdInput = document.getElementById('highlight-plan-id');
