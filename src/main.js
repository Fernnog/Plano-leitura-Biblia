 ...
 * VERSÃO 1.1.0 - Inclui funcionalidade de Marcação de Versículos (Highlights) e Suporte PWA.
 */
...
async function handleSaveHighlight(planId, chapterName, versesStr) {
    ...
    try {
        ...
        alert(`Versículos de ${chapterName} salvos com sucesso! Veja no seu histórico.`);
    } catch (error) {
...
function initApplication() {
    ...
    // REGISTRO DO SERVICE WORKER (Para o Tablet Lenovo reconhecer o PWA)
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('./sw.js')
            .then(reg => console.log("Service Worker registrado com sucesso (PWA Ativo)."))
