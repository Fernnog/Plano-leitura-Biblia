...
/**
 * ATUALIZA os dados de um plano existente (nome, ícone, link).
 * @param {string} userId - O UID do usuário.
 * @param {string} planId - O ID do plano a ser atualizado.
 * @param {object} updatedData - Um objeto com os campos a serem atualizados. Ex: { name, icon, googleDriveLink }.
